...
class InterfuserAgent(autonomous_agent.AutonomousAgent):
    ...
    def run_step(self, input_data, timestamp):
        ...
        # Use BEV semantic map with boxes if available; else fall back
        if "bev_sem_with_boxes" in tick_data:
            tick_data["map"] = tick_data["bev_sem_with_boxes"]
        else:
